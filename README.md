...
Búsqueda de clima por ciudad.
 ...
 Conversión automática de ciudad a coordenadas (geocoding).
...
Se consultan sus coordenadas usando la API de geocoding.

Con esas coordenadas se solicita el clima a Open-Meteo.
